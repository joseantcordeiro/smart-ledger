...
export class ERC20Contract {
	 ...
	 */
	constructor(web3: Web3, contractAddr: string, contractAbi: Array<any> | null = null) {
	 ...
	 */
	allowance(walletAddr: string, spenderAddr: string) {
	 ...
	 */
	transfer(toAddr: string, value: string) {
	 ...
	 * @return {TransactionObject} Whether the transfer was successful or not
	 */
	transferFrom(fromAddr: string, toAddr: string, value: string) {
	 ...
	 */
	approve(spenderAddr: string, value: string) {
